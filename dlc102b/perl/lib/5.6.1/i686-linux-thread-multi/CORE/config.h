 ...
 */
#define ARCHLIB "/usr/local/lib/perl5/5.6.1/i686-linux-thread-multi"		/**/
#define ARCHLIB_EXP "/usr/local/lib/perl5/5.6.1/i686-linux-thread-multi"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl5/site_perl/5.6.1/i686-linux-thread-multi"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl5/site_perl/5.6.1/i686-linux-thread-multi"		/**/
 ...
 *	lib/lib.pm will automatically search in /usr/local/lib/perl5/site_perl/5.6.1/i686-linux-thread-multi for older
